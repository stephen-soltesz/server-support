...
slicename_to_rsyncpath = {
    ...
    'iupui_ndt'     : ['7999/ndt'],
    'iupui_npad'    : ['7999/npad', '7999/sidestream', '7999/paris-traceroute'],
...
rsyncpath_to_filesystempath = {
    '54321/pathload2'       : ['/var/spool/gt_partha', '/home/gt_partha/pathload2'],
    '54321/shaperprobe'     : ['/var/spool/gt_partha', '/home/gt_partha/shaperprobe/dropbox'],
    '7999/ndt'              : ['/var/spool/iupui_ndt'],
    '7999/npad'             : ['/var/spool/iupui_npad/NPAD.v1'],
    '7999/sidestream'       : ['/var/spool/iupui_npad/SideStream'],
    '7999/paris-traceroute' : ['/var/spool/iupui_npad/paris-traceroute'],
    '7999/neubot'           : ['/var/spool/mlab_neubot', '/var/lib/neubot'],
    '7999/glasnost'         : ['/var/spool/mpisws_broadband', 
                               '/home/mpisws_broadband/glasnost',
        ...
        for rsync_path in slicename_to_rsyncpath[slicename]:
            ...
            if search_pattern in row.title.text:
                ...
                if row.custom['lastsuccessfulcollection'].text is not None:
                    ...
                    path_list = rsyncpath_to_filesystempath[rsync_path]
...
def save_last_collection_date_in_vserver(slicename, date):
    path = "/vservers/%s/home/%s/last_collection_date" % (slicename, slicename)
    f = open(path, 'w')
    f.write(date)
    f.close()
...
def main():
    ...
    for slicename in slice_list:
        ...
        for (path,date) in date_list:
            ...
            save_last_collection_date_in_vserver(slicename, date)
